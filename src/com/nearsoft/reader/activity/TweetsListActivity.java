...
public class TweetsListActivity extends ListActivity {
	...
	private void prepareTweets() {
		_progressDialog = ProgressDialog.show(this, "", "Loading tweets, please wait...", false);
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			ArrayAdapter<TwitterEntry> adapter = new TwitterArrayAdapter(TweetsListActivity.this, _twitterReader.getTweets());
